...
<TouchableOpacity
 activeOpacity={0.6}
      ...
      style={{alignItems:'center'}}>
      <Card style={{ marginVertical:10, marginHorizontal:20, padding: 20, height:150, overflow:'hidden', width:300 }}>
      <Image source={require('../assets/travel.png')} style={{zIndex:-1, position:'absolute',resizeMode:'stretch', borderRadius:10,}}/>
...
<TouchableOpacity
 ...
 activeOpacity={0.6}
      ...
      style={{alignItems:'center'}}>
      <Card style={{  marginVertical:10, marginHorizontal:20, padding: 20, height:150, overflow:'hidden', width:300 }}>
      <Image source={require('../assets/Weather.png')} style={{zIndex:-1, position:'absolute',resizeMode:'stretch', borderRadius:10,}}/>
 ...
 activeOpacity={0.6}
      ...
      style={{alignItems:'center'}}>
      <Card style={{  marginVertical:10, marginHorizontal:20, padding: 20, height:150, overflow:'hidden', width:300 }}>
      <Image source={require('../assets/House.png')} style={{zIndex:-1, position:'absolute',resizeMode:'stretch', borderRadius:10,}}/>
        <Text style={{ fontSize: 30, fontWeight: '500' }}>Home Items</Text>
        <Text style={{ fontSize: 15 }}>
          ..
        </Text>
        <View style={{ alignItems: 'flex-end' }}>
 ...
 activeOpacity={0.6}
      ...
      style={{alignItems:'center'}}>
      <Card style={{  marginVertical:10, marginHorizontal:20, padding: 20, height:150, overflow:'hidden', width:300 }}>
      <Image source={require('../assets/School.png')} style={{zIndex:-1, position:'absolute',resizeMode:'stretch', borderRadius:10,}}/>
        <Text style={{ fontSize: 30, fontWeight: '500' }}>School</Text>
        <Text style={{ fontSize: 15 }}>
          ..
        </Text>
        <View style={{ alignItems: 'flex-end' }}>
